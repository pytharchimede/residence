...
function shb_booking_form_single_horizontal_shortcode( $atts, $content = null ) {
	...
	<?php if($accommodation_exists == true) { ?>
		...
		<form class="shb-booking-form-style-1 shb-booking-form-1-column-5 shb-clearfix" action="<?php echo $booking_page_url; ?>" method="post">
...
add_shortcode( 'shb_booking_form_single_horizontal', 'shb_booking_form_single_horizontal_shortcode' );
