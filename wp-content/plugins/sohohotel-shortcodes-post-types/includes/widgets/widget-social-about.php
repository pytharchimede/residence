...
---------------------------------------------------------------------------- */
	...
	function widget( $args, $instance ) {
		...
		<div class="sohohotel-footer-social-icons-wrapper">
			...
			<?php if ($facebook != '') {echo '<a target="_blank" href="' . $instance['facebook'] . '"><i class="fab fa-facebook-f"></i></a>';} ?>
			<?php if ($twitter != '') {echo '<a target="_blank" href="' . $instance['twitter'] . '"><i class="fab fa-twitter"></i></a>';} ?>
			<?php if ($instagram != '') {echo '<a target="_blank" href="' . $instance['instagram'] . '"><i class="fab fa-instagram"></i></a>';} ?>
			<?php if ($yelp != '') {echo '<a target="_blank" href="' . $instance['yelp'] . '"><i class="fab fa-yelp"></i></a>';} ?>
			<?php if ($youtube != '') {echo '<a target="_blank" href="' . $instance['youtube'] . '"><i class="fab fa-youtube"></i></a>';} ?>
			<?php if ($tripadvisor != '') {echo '<a target="_blank" href="' . $instance['tripadvisor'] . '"><i class="fab fa-tripadvisor"></i></a>';} ?>
			<?php if ($pinterest != '') {echo '<a target="_blank" href="' . $instance['pinterest'] . '"><i class="fab fa-pinterest"></i></a>';} ?>
			<?php if ($skype != '') {echo '<a target="_blank" href="' . $instance['skype'] . '"><i class="fab fa-skype"></i></a>';} ?>
			<?php if ($flickr != '') {echo '<a target="_blank" href="' . $instance['flickr'] . '"><i class="fab fa-flickr"></i></a>';} ?>
			<?php if ($googleplus != '') {echo '<a target="_blank" href="' . $instance['googleplus'] . '"><i class="fab fa-google-plus"></i></a>';} ?>
			<?php if ($tumblr != '') {echo '<a target="_blank" href="' . $instance['tumblr'] . '"><i class="fab fa-tumblr"></i></a>';} ?>
			<?php if ($vimeo != '') {echo '<a target="_blank" href="' . $instance['vimeo'] . '"><i class="fab fa-vimeo"></i></a>';} ?>
...
---------------------------------------------------------------------------- */
	...
	function form( $instance ) {
		...
		<p>
			...
			<textarea class="widefat" id="<?php echo esc_attr($this->get_field_id('about_us')); ?>" name="<?php echo esc_attr($this->get_field_name('about_us')); ?>"><?php echo esc_attr($instance['about_us']); ?></textarea>
		</p>
