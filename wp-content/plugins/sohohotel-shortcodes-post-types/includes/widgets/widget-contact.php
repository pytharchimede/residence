...
---------------------------------------------------------------------------- */
	...
	function widget( $args, $instance ) {
		...
		<ul class="sohohotel-contact-widget">
			...
			<?php if ($contact_phone != '') {echo '<li class="sohohotel-phone"><a href="tel:'. esc_textarea($instance['contact_phone']) . '">'. esc_textarea($instance['contact_phone']) . '</a></li>';} ?>
			<?php if ($contact_email != '') {echo '<li class="sohohotel-email"><a href="mailto:'. esc_textarea($instance['contact_email']) . '">'. esc_textarea($instance['contact_email']) . '</a></li>';} ?>
		</ul>
