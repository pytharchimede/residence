				...
				<div class="sohohotel-blog-block">
					...
					<?php if( has_post_thumbnail() ) { ?>
						...
						<a href="<?php esc_url(the_permalink()); ?>" rel="bookmark" title="<?php the_title_attribute(); ?>" class="sohohotel-blog-block-image">
							<?php $src = wp_get_attachment_image_src( get_post_thumbnail_id($post->ID), 'sohohotel-image-style10' ); ?>
					...
					<p class="sohohotel-blog-date"><i class="fas fa-calendar"></i><?php the_time( get_option( 'date_format' ) ); ?></p>
