...
function sohohotel_icon_text_shortcode( $atts, $content = null ) {
	...
	if ( $icon1 ) {
		...
		<div class="sohohotel-icon"><i class="fas ' . $icon1 . '"></i></div>
	...
	if ( $icon2 ) {
		$output .= '<div class="sohohotel-icon-text-block sohohotel-clearfix">
		<div class="sohohotel-icon"><i class="fas ' . $icon2 . '"></i></div>
		<div class="sohohotel-text">
			<h4>' . $title2 . '</h4>
			<p>' . $content2 . '</p>
		</div>
	...
	if ( $icon3 ) {
		$output .= '<div class="sohohotel-icon-text-block sohohotel-clearfix">
		<div class="sohohotel-icon"><i class="fas ' . $icon3 . '"></i></div>
		<div class="sohohotel-text">
			<h4>' . $title3 . '</h4>
			<p>' . $content3 . '</p>
		</div>
	...
	if ( $icon4 ) {
		$output .= '<div class="sohohotel-icon-text-block sohohotel-clearfix">
		<div class="sohohotel-icon"><i class="fas ' . $icon4 . '"></i></div>
		<div class="sohohotel-text">
			<h4>' . $title4 . '</h4>
			<p>' . $content4 . '</p>
		</div>
